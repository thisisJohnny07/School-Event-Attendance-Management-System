    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
            <!-- incoming events Card -->
            <?php 
              $query1 = mysqli_query($conn, "              SELECT events.*
              FROM events
              LEFT JOIN classEvents ON classEvents.eventId = events.Id
              LEFT JOIN attendance ON attendance.eventId = events.Id
              WHERE events.startDate >= CURDATE() AND attendance.idNumber = '$_SESSION[userId]'
              GROUP BY events.Id"); 
              $incEvents = mysqli_num_rows($query1);
            ?>
                ...
                <div class="card h-100">
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-uppercase mb-1">Incoming Events</div>
                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $incEvents;?></div>
            ...
            <!-- attendance Card -->
            <?php 
              $query1 = mysqli_query($conn, "SELECT attendance.*, class.*, students.*, events.*
              FROM attendance
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $attendance;?></div>
                        <div class="mt-2 mb-0 text-muted text-xs">
                          <!-- <span class="text-success mr-2"><i class="fas fa-arrow-up"></i> 20.4%</span>
                          <span>Since last month</span> -->
                        </div>
