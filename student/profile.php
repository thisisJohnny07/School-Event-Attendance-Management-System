                      ...
                      <div class="col-lg-4">
                          <div class="text-center card-box">
                              <div class="member-card pt-2 pb-2">
                                  <?php
                                      $query = "SELECT students.firstName, class.className, students.lastName, students.Id, students.profile
                                      FROM students
                                  ...
                                  <div class="">
                                      <div class="h4"><?php echo $rows['firstName'] . " " . $rows['lastName'] . " (" . $rows['className'] . ")";  ?></div>
                                      <p class="text-muted">ID <span>| </span><span><a href="#" class="text-pink"><?php echo $rows['Id']  ?></a></span></p>
                                  </div>
