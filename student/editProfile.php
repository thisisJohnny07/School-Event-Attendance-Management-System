...
$query = mysqli_query($conn,"SELECT password, firstName, lastName, profile FROM students WHERE Id ='$_SESSION[userId]'");
...
if(isset($_POST['update'])) {
    ...
    if (empty($sampPass) && empty($path_tmp)) {
      $query = mysqli_query($conn, "UPDATE students SET firstName='$firstName', lastName='$lastName' WHERE Id='$_SESSION[userId]'");
      ...
      <div id="content">
       ...
       <?php include "Includes/topbarProfile.php";?>
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <?php
              $getInfo=mysqli_query($conn,"SELECT firstName, lastName FROM students WHERE Id ='$_SESSION[userId]'");
