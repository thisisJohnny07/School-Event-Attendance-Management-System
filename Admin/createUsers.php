...
//------------------------SAVE--------------------------------------------------
  ...
  if(isset($_POST['save'])) {
    ...
    $email = $_POST['email'];
    $query=mysqli_query($conn,"select * from admin where Id ='$admissionNumber'");
    ...
    $query=mysqli_query($conn,"INSERT into admin(Id,firstName,lastName,emailAddress,password) 
    value('$admissionNumber','$firstName','$lastName','$email','$sampPass_2')");
...
//--------------------EDIT------------------------------------------------------------
  if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit"){
    ...
    if(isset($_POST['update'])){
      ...
      $query=mysqli_query($conn,"update admin set firstName='$firstName', lastName='$lastName', 
      Id='$admissionNumber', password='$sampPass_2', emailAddress='$email'
      where Id='$Id'");
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                      ...
                      <input type="email" class="form-control" required name="email" value="<?php echo $row['Id'];?>" id="exampleInputFirstName" >
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
