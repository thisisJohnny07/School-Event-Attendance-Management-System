      ...
      <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
          ...
          <div class="container-fluid" id="container-wrapper">
            ...
            <!-- Students Card -->
            <?php 
              $query1 = mysqli_query($conn, "SELECT attendance.*, events.*
                                FROM attendance
                                LEFT JOIN events ON events.Id = attendance.eventId
                                GROUP BY events.Id");
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <a href="eventAttendanceRecord.php?Id=<?php echo $row['Id'] ?>">View Reports</a>
