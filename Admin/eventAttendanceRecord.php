                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                        <div class="col-xl-6">
                          ...
                          <input type="text" class="form-control" required name="className" >
                        </div>
                    </div>
                      <?php
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                    ...
                    if(isset($_POST['view']) && isset($_GET['Id'])){
                        $eventId = $_GET['Id'];
                       $className =  $_POST['className'];
                        ...
                        where class.className = '$className' and attendance.eventId = $eventId";
                    ...
                    echo "<a href='?action=edit&Id=".$rows['Id']."'><i class='fas fa-fw fa-edit'></i></a>";
                      ?>
                    </tbody>
                  </table>
                </div>
