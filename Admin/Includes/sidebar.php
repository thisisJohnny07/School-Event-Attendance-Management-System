 <ul class="navbar-nav sidebar sidebar-light accordion " id="accordionSidebar">
     <a class="sidebar-brand d-flex align-items-center bg-gradient-success  justify-content-center" href="index.php">
         <div class="sidebar-brand-icon">
             <img src="img/logo/ndmulogo.png">
         </div>
         <div class="sidebar-brand-text mx-3">CheckInTrace</div>
     </a>
     ...
     <li class="nav-item">
         ...
         <div id="collapseBootstrap2" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <a class="collapse-item" href="createEvent.php">Create Events</a>
                 <a class="collapse-item" href="eventsList.php">Take Event Attendance</a>
                 <a class="collapse-item" href="eventsListEdit.php">Edit Event Attendance</a>
                 <a class="collapse-item" href="viewStudentAttendance.php">View Student Attendance</a>
                 <a class="collapse-item" href="viewEventAttendance.php">View Events Attendance</a>
